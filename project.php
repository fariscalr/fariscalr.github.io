...
<body>
    ...
    <script>
            ...
            geocoder.geocode(address, function(results) {
                if (results.length > 0) {
                    ...
                    userMarker = L.marker(location, {
                        icon: L.icon({
                            iconUrl: 'https://upload.wikimedia.org/wikipedia/commons/6/6b/Map_marker.svg', // URL ikon koordinat standar
                            iconSize: [32, 32], // Ukuran ikon
                            iconAnchor: [16, 32], // Titik koordinat ikon
                        })
                    })
        ...
        // Event listener untuk menambahkan marker saat klik peta
